...
<body>
  <header style="background-color: #9c653d;">
    ...
    <div class="brand" style="display: flex; align-items:center;">
      <img src="public/imgs/hero/logo.png" alt="Coffee Logo" class="logo"
        style="height:40px; width:auto; border-radius:17px;" />
      <h1>{{SITE_TITLE}}</h1>
    </div>
    ...
    <span>{{if ~CART_ITEMS}}<a href="index.php?page=Sec-Login"><i class="fa-solid fa-cart-shopping"
